...
export default class ScrollViewOne extends Component {
    render(){ 
        return (
            <View style={styles.content.container}>
                <Text style={styles.content.title}>Pierwszy ScrollView</Text>
                ...
                <ScrollView style={styles.content.textCode}>
                    <Text style={styles.content.title}>Lorem ipsum</Text>
